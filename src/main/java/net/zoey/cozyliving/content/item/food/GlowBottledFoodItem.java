...
public class GlowBottledFoodItem extends BottledFoodItem implements SignApplicator {
    public GlowBottledFoodItem(Properties properties, int timeToDrink) {
        super(properties, timeToDrink);
    }

    public GlowBottledFoodItem(
        Properties properties,
        int timeToDrink,
        SoundEvent drinkingSound
    ) {
        super(properties, timeToDrink, drinkingSound);
    }
