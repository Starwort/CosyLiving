...
public class ModItemTagsProvider extends ItemTagsProvider {
    ...
    protected void addTags(@NotNull HolderLookup.Provider provider) {
        tag(ModTags.Items.COCONUT_LOGS)
        ...
        tag(ModTags.Items.COZYLIVING_STARTER_ITEMS)
                .add(ModBlocks.RASPBERRY_BUSH.asItem())
        ...
        tag(ModTags.Items.COTTON_ITEMS)
                .add(ModBlocks.COTTON_CROP.asItem())
                .add(ModBlocks.COTTON_SHRUB.asItem());

        tag(ModTags.Items.ICE_CREAMS)
        ...
        tag(ItemTags.SIGNS)
                .add(ModItems.COCONUT_SIGN.item());
        tag(ItemTags.HANGING_SIGNS)
                .add(ModItems.COCONUT_HANGING_SIGN.item());

        tag(ItemTags.BOATS)
                .add(ModItems.COCONUT_BOAT.item());
        tag(ItemTags.CHEST_BOATS)
                .add(ModItems.COCONUT_CHEST_BOAT.item());
