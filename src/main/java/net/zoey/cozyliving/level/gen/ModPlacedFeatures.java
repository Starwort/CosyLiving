...
public class ModPlacedFeatures {
    ...
    //public static final ResourceKey<PlacedFeature> PATCH_RASPBERRIES_PLACED_KEY = registerKey("patch_raspberries_placed");
    public static final ResourceKey<PlacedFeature> PATCH_COTTON_SHRUB_PLACED_KEY = registerKey("patch_cotton_shrub_placed");
    public static final ResourceKey<PlacedFeature> PATCH_LUSH_COTTON_SHRUB_PLACED_KEY = registerKey("patch_lush_cotton_shrub_placed");
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context) {
        ...
        /*register(context, PATCH_RASPBERRIES_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.PATCH_RASPBERRIES_KEY),
        ...
        register(context, PATCH_COTTON_SHRUB_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.PATCH_COTTON_SHRUB_KEY),
                List.of(RarityFilter.onAverageOnceEvery(31), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE,
                        BiomeFilter.biome()));

        register(context, PATCH_LUSH_COTTON_SHRUB_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.PATCH_LUSH_COTTON_SHRUB_KEY),
                List.of(CountPlacement.of(999), //TODO: this is for developement only lol
