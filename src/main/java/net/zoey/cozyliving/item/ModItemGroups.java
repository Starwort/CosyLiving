...
public class ModItemGroups {
    ...
    public static final ItemGroup COZYLIVINGITEMGROUP;

    static {
        COZYLIVINGITEMGROUP = Registry.register(Registries.ITEM_GROUP,
                ...
                FabricItemGroup.builder().icon(() -> new ItemStack(ModItems.RASPBERRY))
                        ...
                        .entries((displayContext, entries) -> {
                            ...
                            entries.add(ModItems.GLOWBERRY_JAM_DONUT);
                            ...
                            entries.add(ModItems.MAO_CROQUI);
                            ...
                            entries.add(ModItems.RASPBERRY_JAM_DONUT);
                            ...
                            entries.add(ModItems.SWEETBERRY_JAM_DONUT);
